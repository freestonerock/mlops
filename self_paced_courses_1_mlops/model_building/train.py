...
Xtrain_path = "datasets/Xtrain.csv"                    # enter the Hugging Face username here=>hf://datasets/PASTE_YOUR_HUGGING_FACE_USER_NAME/PIMA-Diabetes-Prediction/Xtrain.csv
Xtest_path = "datasets/Xtest.csv"                      # enter the Hugging Face username here=>hf://datasets/PASTE_YOUR_HUGGING_FACE_USER_NAME/PIMA-Diabetes-Prediction/Xtest.csv
ytrain_path = "datasets/ytrain.csv"                    # enter the Hugging Face username here=>hf://datasets/PASTE_YOUR_HUGGING_FACE_USER_NAME/PIMA-Diabetes-Prediction/ytrain.csv
ytest_path = "datasets/ytest.csv"                      # enter the Hugging Face username here=>hf://datasets/PASTE_YOUR_HUGGING_FACE_USER_NAME/PIMA-Diabetes-Prediction/ytest.csv
